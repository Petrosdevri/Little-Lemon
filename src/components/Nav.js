            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav justify>
                        ...
                        <li>
                            <Link to="/" {...hover}>Home</Link>
                        </li>
                        <li>
                            <Link to="/about" {...hover2}>About</Link>
                        </li>
                        <li>
                            <Link to="/menu" {...hover3}>Menu</Link>
                        </li>
                        <li>
                            <Link to="/reservations" {...hover4}>Reservations</Link>
                        </li>
                        <li>
                            <Link to="/order-online" {...hover5}>Order Online</Link>
                        </li>
                        <li>
                            <Link to="/login" {...hover6}>Login</Link>
                        </li>
                    </Nav>
                </Navbar.Collapse>
            </Container>
